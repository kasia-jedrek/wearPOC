package makolab.com.watchtestpoc;/*
...
import makolab.com.watchtestpoc.fragments.AssetFragment;
import makolab.com.watchtestpoc.fragments.DataFragment;
import makolab.com.watchtestpoc.fragments.DiscoveryFragment;

import static makolab.com.watchtestpoc.DataLayerListenerService.LOGD;
...
//     }
    ...
    class MyTask extends AsyncTask<DataEvent, DataEvent, DataEvent> {

        @Override
        protected DataEvent doInBackground(DataEvent... params) {

            DataEvent event = params[0];
...
//                    });
    ...
    MyTask updateInterfaceWithData;

    @Override
    public void onDataChanged(DataEventBuffer dataEvents) {
        LOGD(TAG, "onDataChanged(): " + dataEvents);
        updateInterfaceWithData=  new MyTask();
        ...
        for (DataEvent event : events) {
            ...
            updateInterfaceWithData.doInBackground(event);
        }
    }
    ...
    private Bitmap loadBitmapFromAsset(GoogleApiClient apiClient, Asset asset) {
        ...
        Wearable.DataApi.getFdForAsset(
                apiClient, asset).setResultCallback(new ResultCallbacks<DataApi.GetFdForAssetResult>() {
                                                        @Override
                                                        public void onSuccess(DataApi.GetFdForAssetResult getFdForAssetResult) {
