        ...
        OnConnectionFailedListener
{
    ...
    private void sendPhoto(Asset asset) {
        ...
        dataMap.getDataMap().putAsset(IMAGE_KEY,asset);// // toAsset( BitmapFactory.decodeResource(getResources(), R.drawable.bird))
    ...
    public void onShowNotificationSend(View view)   {

         int notificationId = 001;
         // Build intent for notification content
         Intent viewIntent = new Intent(this, OpenMeActivity.class);
         viewIntent.putExtra("ExtraEvent", "101");
...
//                new NotificationCompat.Action.Builder(R.drawable.bird,
...
//                        .setContentText("Powiadomienie content")
...
// Extend the notification builder with the second page
        Notification notification = notificationBuilder
         ...
         notificationManager.notify(notificationId, notificationBuilder.build());//notificationBuilder.BUILD()
    ...
    private void setupViews() {
        ...
        mDataItemList = (ListView) findViewById(android.R.id.list);
